...
export const OCCASION_CONFIG = {
  birthday:    { cardTitle: 'Happy Level Up Day! 🥳',       slide1: 'Hey {name} 🤭❤️',  slide3: "It's your special day! 🎂",       slide5: 'Wishing you a long life\nand good health always 🥰', particleColor: '#ffb3c6', giftBoxShape: 'classic', vantaColors: { highlightColor: 0xff9eb1, midtoneColor: 0xff5c8a, lowlightColor: 0x2a0512, baseColor: 0x120309 } },
  anniversary: { cardTitle: 'Happy Anniversary! 💍',         slide1: 'Hey {name} 💕',    slide3: 'Celebrating your love! 💍',        slide5: 'Wishing you endless love\nand happiness together 🥰', particleColor: '#ffcad4', giftBoxShape: 'heart',   vantaColors: { highlightColor: 0xff6b81, midtoneColor: 0xc9184a, lowlightColor: 0x2b0a12, baseColor: 0x14040a } },
  graduation:  { cardTitle: 'Congratulations! 🎓',           slide1: 'Hey {name} 🎉',    slide3: 'You did it! 🎓',                   slide5: 'Wishing you great success\nin all your future endeavors! 🚀', particleColor: '#a8b8ff', giftBoxShape: 'dome',    vantaColors: { highlightColor: 0x8ea9ff, midtoneColor: 0x3a3aff, lowlightColor: 0x0a0a2b, baseColor: 0x05051a } },
  newjob:      { cardTitle: 'Congrats on the New Role! 🚀',  slide1: 'Hey {name} 💼',    slide3: 'A new chapter begins! 💼',         slide5: 'Wishing you tremendous success\nin your new journey! ⭐', particleColor: '#8fe3d8', giftBoxShape: 'classic', vantaColors: { highlightColor: 0x7fe9d8, midtoneColor: 0x149aa0, lowlightColor: 0x03191c, baseColor: 0x02100f } },
...
const DEFAULT_GIFT_BOX_SHAPE = 'classic'
...
export function getOccasionConfig(type) {
  ...
  return {
    ...
    giftBoxShape: DEFAULT_GIFT_BOX_SHAPE,
