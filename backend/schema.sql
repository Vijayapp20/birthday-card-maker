...
CREATE TABLE IF NOT EXISTS photo_uploads (
  ...
  photo_url         VARCHAR(500)    NOT NULL COMMENT 'Cloudinary secure_url for the uploaded photo',
...
CREATE TABLE IF NOT EXISTS birthday_cards (
  ...
  photo_url       VARCHAR(500)  COMMENT 'Cloudinary secure_url for the uploaded photo',
